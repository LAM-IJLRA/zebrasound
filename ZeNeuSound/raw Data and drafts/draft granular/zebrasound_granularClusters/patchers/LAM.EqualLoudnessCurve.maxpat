...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 411.0, 87.0, 69.0, 20.0 ],
					"text" : "clip 0. 180."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 411.0, 113.0, 32.5, 20.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					"comment" : "dB SPL (float)",
					"id" : "obj-8",
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 381.0, 478.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.0, 478.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 132.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 411.0, 57.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"comment" : "frequency Hz (float)",
					"id" : "obj-1",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 205.0, 57.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 85.0, 87.0, 34.0, 20.0 ],
					"text" : "t 0 b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 85.0, 62.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 755.0, 420.0, 45.0, 20.0 ],
					"text" : "Freqs"
				}
...
,
					"patching_rect" : [ 85.0, 172.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 445.0, 91.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 140.0, 38.0, 20.0 ],
					"text" : "freq"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 445.0, 114.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 140.0, 50.0, 20.0 ]
				}

			}
, 			{
				"box" : 				{
					"addpoints" : [ 20.0, 76.551735, 0, 25.0, 65.618874, 0, 31.5, 55.122826, 0, 40.0, 45.533985, 0, 50.0, 37.632118, 0, 63.0, 30.864979, 0, 80.0, 25.023792, 0, 100.0, 20.510012, 0, 125.0, 16.645819, 0, 160.0, 13.116014, 0, 200.0, 10.088258, 0, 250.0, 7.810055, 0, 315.0, 5.291776, 0, 400.0, 3.146503, 0, 500.0, 1.541179, 0, 630.0, 0.337863, 0, 800.0, -0.383171, 0, 1000.0, -0.454632, 0, 1250.0, 0.811688, 0, 1600.0, -0.688591, 0, 2000.0, -3.686383, 0, 2500.0, -6.910561, 0, 3150.0, -9.278403, 0, 4000.0, -9.194584, 0, 5000.0, -5.565334, 0, 6300.0, 2.493632, 0, 8000.0, 9.916278, 0, 10000.0, 11.865037, 0 ],
					"domain" : 15000.0,
					"id" : "obj-16",
					"maxclass" : "function",
					"numinlets" : 1,
					...
					"outlettype" : [ "float", "", "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 85.0, 220.0, 705.0, 199.0 ],
					"range" : [ -20.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 132.0, 36.0, 20.0 ],
					"text" : "phon"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 214.5, 204.5, 94.5, 204.5 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 109.5, 115.0, 142.5, 115.0 ],
					"source" : [ "obj-49", 1 ]
				}
